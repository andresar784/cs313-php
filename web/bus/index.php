...
<div class="container">
	...
	<input type="hidden" id="showprice" name="price">
	<button type="submit" class="btn btn-primary btn-lg" onclick="calculatePrice()"> Confirm 1/4</button>
	</div>
...
<script>
 function calculatePrice(){  
  ...
  document.getElementById("showprice").element.attribute = price;
